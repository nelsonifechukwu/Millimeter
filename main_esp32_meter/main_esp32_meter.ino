...
const char* serverName1 = "http://millimeter.symmetrical-happiness.com/backend/sensor_post.php";
const char* serverName2 = "http://millimeter.symmetrical-happiness.com/backend/sensor_post2.php?id=1";
